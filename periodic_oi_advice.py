...
every 5 minutes with market question, condition ID (contract address), and recommendation reason.
"""
    ...
    try:
        ...
        if 'data' in data and data['data'] or isinstance(data, list):
            ...
            for market in sorted_markets:
                ...
                # Get the outcomes and their prices
                outcomes = eval(market.get('outcomes', "['N/A', 'N/A']"))  # Convert string representation to list
                outcome_prices = eval(market.get('outcomePrices', "[0, 0]"))  # Convert string representation to list
        ...
        # Append to log file
        with open("/root/clawd/polymarket_advice.log", "a", encoding="utf-8") as f:
            f.write('\n'.join(output_lines) + '\n')
